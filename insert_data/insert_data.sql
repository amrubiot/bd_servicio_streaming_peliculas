...
VALUES
(1, 1, 'Tarjeta de credito', '2025-04-01', '2025-05-01', 1, 'activa'),
(2, 2, 'PayPal', '2025-04-02', '2025-05-02', 1, 'activa'),
(3, 3, 'Tarjeta de debito', '2025-04-03', '2025-05-03', 0, 'vencida'),
(4, 4, 'Tarjeta de credito', '2025-04-04', '2025-10-04', 1, 'activa'),
(5, 5, 'Transferencia bancaria', '2025-04-05', '2025-10-05', 1, 'activa'),
(6, 6, 'Tarjeta de debito', '2025-04-06', '2025-10-06', 0, 'vencida'),
(7, 1, 'Tarjeta de credito', '2025-04-07', '2025-05-07', 1, 'activa'),
(8, 2, 'PayPal', '2025-04-08', '2025-05-08', 0, 'cancelada'),
(9, 3, 'Tarjeta de debito', '2025-04-09', '2025-05-09', 1, 'activa'),
(10, 4, 'Transferencia bancaria', '2025-04-10', '2025-10-10', 1, 'activa');

INSERT INTO historial_visualizacion
VALUES
(1, 2, 'ingles', 'espanol', 98, 1, 1, 0),
(2, 1, 'espanol', 'espanol', 120, 0, 1, 1),
(3, 3, 'ingles', NULL, 40, 1, 0, 0),
(4, 5, 'ingles', 'portugues', 90, 0, 1, 0),
(5, 4, 'espanol', 'espanol', 75, 1, 0, 1),
(6, 6, 'ingles', 'espanol', 115, 0, 1, 0),
(7, 7, 'espanol', NULL, 30, 1, 0, 0),
(8, 3, 'ingles', 'frances', 60, 1, 0, 0),
(9, 2, 'espanol', 'espanol', 98, 0, 1, 1),
(10, 8, 'ingles', NULL, 45, 0, 0, 0),
(11, 9, 'ingles', 'aleman', 110, 1, 1, 0),
(12, 1, 'espanol', 'espanol', 118, 0, 1, 1),
(13, 5, 'ingles', NULL, 88, 1, 1, 0),
(14, 6, 'ingles', 'espanol', 60, 0, 0, 0),
(15, 4, 'espanol', NULL, 76, 1, 1, 1);

INSERT INTO valoracion
VALUES
(1, 2, '2025-05-10', 8, 'Muy buena pelicula, la recomiendo.', 0, 5),
(2, 1, '2025-05-15', 7, 'Entretenida pero predecible.', 0, 3),
(3, 3, '2025-05-20', 9, 'Excelente actuacion y efectos.', 0, 7),
(4, 5, '2025-05-22', 6, 'Buena para pasar el rato.', 0, 1),
(5, 4, '2025-05-25', 5, NULL, 1, 0),
(6, 6, '2025-05-28', 8, 'Historia interesante y bien contada.', 0, 4),
(7, 7, '2025-05-30', 7, 'Buena pero esperaba mas.', 0, 2),
(8, 3, '2025-05-31', 10, 'Me encantó, de mis favoritas.', 0, 9),
(9, 2, '2025-06-01', 6, NULL, 0, 1),
(10, 1, '2025-06-02', 9, 'Muy recomendable para los fans del genero.', 0, 6);
